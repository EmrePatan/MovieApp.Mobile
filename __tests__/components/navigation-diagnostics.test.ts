...
describe('navigation diagnostics', () => {
  ...
  it('uses the v5 diagnostic build marker', () => {
    expect(NAV_DIAGNOSTIC_BUILD_ID).toBe('MA-45-2026-09-21-v5');
  });
  ...
  it('logs platform and render counters from useScreenRenderTrace', () => {
    ...
    expect(mockLog).toHaveBeenCalledWith(
      expect.stringContaining('[NAV_DIAG:MA-45-2026-09-21-v5] trace:search'),
