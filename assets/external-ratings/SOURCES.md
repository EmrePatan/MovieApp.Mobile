...
| `metacritic-icon.png` | Metacritic (compact) | Rasterized from `metacritic.svg` |
...
Runtime UI uses bundled PNGs for React Native. Detail chips use **icon** variants (`*-icon.png`) where available; wordmarks remain for larger/default use. Re-rasterize after SVG updates with `sharp` (wordmarks: IMDb 320, Letterboxd 280, Metacritic 280, TMDB 120; icons: 128px square where applicable).
